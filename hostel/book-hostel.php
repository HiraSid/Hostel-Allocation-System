...
<option value="1">Disang</option>
<option value="2">Barak</option>
<option value="3">Brahmaputra</option>
<option value="4">Lohit</option>
<option value="5">Umiam</option>
<option value="6">Dihing</option>
<option value="7">Siang</option>
<option value="8">Manas</option>
<option value="9">Dhansiri</option>
<option value="10">Subansiri</option>
<option value="11">Kameng</option>
<option value="12">Dibang</option>
</select>
</div>
</div>
<div class="form-group">
